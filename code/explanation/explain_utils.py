...
def get_explain_instruction():
    user_instruction = """The following scenario exhibits stereotypical bias. Please give a very short explanation after \"Explanation:\". Here is the scenario: \n###scenario###"""
